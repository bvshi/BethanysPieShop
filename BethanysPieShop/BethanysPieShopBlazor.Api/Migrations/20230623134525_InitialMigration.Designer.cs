...
namespace BethanysPieShopBlazor.Api.Migrations
{
    ...
    [Migration("20230623134525_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BethanysPieShopBlazor.Shared.Country", b =>
                {
            ...
            modelBuilder.Entity("BethanysPieShopBlazor.Shared.Employee", b =>
                {
            ...
            modelBuilder.Entity("BethanysPieShopBlazor.Shared.JobCategory", b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BethanysPieShopBlazor.Shared.Employee", b =>
                {
                    b.HasOne("BethanysPieShopBlazor.Shared.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BethanysPieShopBlazor.Shared.JobCategory", "JobCategory")
                        .WithMany()
